...
(custom-set-faces
 ...
 '(bold ((t (:foreground "gold4" :slant normal :weight bold :height 132 :width normal :foundry "CTDB" :family "Fira Mono"))))
 ...
 '(mode-line ((t (:background "grey75" :foreground "black" :box -1 :slant normal :width condensed :family "Fira Sans Compressed Regular"))))
