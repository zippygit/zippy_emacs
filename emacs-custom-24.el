...
(custom-set-faces
 ...
 '(font-lock-function-name-face ((t (:foreground "indianred3"))))
 '(font-lock-keyword-face ((t (:foreground "darkgoldenrod"))))
 '(font-lock-string-face ((t (:foreground "steelblue3"))))
 '(font-lock-variable-name-face ((t (:foreground "turquoise4"))))
 '(isearch ((t (:background "lightpink"))))
